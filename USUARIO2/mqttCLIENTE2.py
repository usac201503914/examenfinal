...
import logging
import time
import random                                                   #########THCP FUNCIONA SEGÚN PRUEBAS REALIZADAS ENVIANDO ARCHIVOS AL MISMO CLIENTE
import socket                                                   #########POR ALGUNA RAZÓN DESCONOCIDA NO FUNCIONÁ A TERCEROS SEGÚN PRUEBAS, SE BUSCÓ EXHAUSTIVAMENTE PERO NO
import threading #Concurrencia con hilos                        #########SE ENCONTRÓ LA RAZÓN Y EL PROGRMA NO DIÓ NINGUN ERROR
import binascii
import os
import sys
